                ...
                <div class="form-container mt-4 custom-login" style="max-width: 50%; margin-bottom: 100px">
                    ...
                    <div class="row g-3">
                        <div class="col-12">
                            ...
                            <asp:TextBox ID="TexNombreDonante" runat="server" type="text" class="form-control" ReadOnly="true"></asp:TextBox>
                        </div>

                        <div class="col-12">
                            <label for="ApellidoDonante" class="form-label">Apellido Donante</label>
                            <asp:TextBox ID="TexApeliidoDonante" runat="server" type="text" class="form-control" ReadOnly="true"></asp:TextBox>
                        </div>

                        <div class="col-12">
                            <label for="DniDonante" class="form-label">DNI Donante</label>
                            <asp:TextBox ID="TexDIN" runat="server" type="text" class="form-control" ReadOnly="true"></asp:TextBox>
                        </div>
